...
import { detectTwoFridasLocale, resolveTwoFridasCopy } from "../utils/twoFridasLocale"
import { useSearchParams } from "react-router-dom"

const ARTWORK_SLUG = "two-fridas"

export default function TwoFridasPage() {
  const [searchParams] = useSearchParams()
  const locale = detectTwoFridasLocale(searchParams)
  const copy = resolveTwoFridasCopy(locale)
